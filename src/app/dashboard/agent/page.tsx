        ...
        <div className="max-w-4xl mx-auto pb-20 font-sans">
            ...
            <div className="grid grid-cols-1 gap-8">
                <div className="bg-[#0f0f0f] p-8 rounded-2xl border border-white/5 shadow-sm">
                    <h3 className="text-lg font-bold mb-6 text-white">Personalidade e Identidade</h3>
                    <div className="space-y-6">
                        <div>
                            <label className="block text-sm font-medium text-gray-300 mb-2">Nome do Agente</label>
                            <input
                                type="text"
                        ...
                        <div>
                            ...
                            <textarea
                                className="w-full px-4 py-3 bg-[#1a1a1a] border border-white/10 text-white rounded-xl focus:outline-none focus:border-purple-600 h-24 transition-colors"
                ...
                <div className="bg-[#0f0f0f] p-8 rounded-2xl border border-white/5 shadow-sm">
                    <h3 className="text-lg font-bold mb-6 text-white">Regras de Agendamento</h3>
                    <div className="space-y-4">
                        <div className="flex items-center justify-between p-4 bg-[#1a1a1a] rounded-xl border border-white/5">
                            <div>
                                <p className="font-bold text-white">Coletar Nome do Cliente</p>
                        ...
                        <div className="flex items-center justify-between p-4 bg-[#1a1a1a] rounded-xl border border-white/5">
                            <div>
                                <p className="font-bold text-white">Confirmar Disponibilidade Manualmente</p>
                                <p className="text-xs text-gray-500">IA perguntará se você aprova antes de marcar</p>
                            </div>
                            <input type="checkbox" className="w-5 h-5 accent-purple-600 bg-transparent border-white/10 rounded" />
                        </div>
                    </div>
                </div>
            </div>
